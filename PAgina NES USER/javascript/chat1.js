...
// js de modal para form
  const modal = document.getElementById('denunciaModal');
    ...
    function handleSubmit(event) {
      ...
      // Validación simple para cada campo
      ...
      if (!ubicacion) {
        showError('ubicacion', 'Por favor, ingrese la ubicación');
        isValid = false;
      } else {
      ...
      if (!Cedula) {
        showError('Cedula', 'Por favor, ingrese la Cedula');
        isValid = false;
      } else {
        clearError('Cedula');
        }
      ...
      if (!tipo) {
        showError('tipo', 'Por favor, seleccione un tipo de denuncia');
        isValid = false;
      } else {
        clearError('tipo');
      }
      ...
      if (!descripcion) {
        showError('descripcion', 'Por favor, ingrese una descripción');
        isValid = false;
      } else {
