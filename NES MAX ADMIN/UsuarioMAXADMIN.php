...
$sql = "SELECT id, nombre, email, password, rol FROM usuarios WHERE rol = 'admin'";
$result = mysqli_query($conn, $sql);


// Procesamiento del formulario para agregar nuevo usuario
$message = '';
$messageType = '';
...
// Procesamiento para editar usuario
...
// Consulta para obtener usuarios con rol normal
$sql = "SELECT id, nombre, email, password, rol FROM usuarios WHERE rol = 'admin'";
$result = mysqli_query($conn, $sql);
